...
public class TokenUtils {
    ...
    public static String getToken(String str) {
        String token = TokenEncryptUtils.encoded(getCurrentTime() +new Random().nextInt(9999999)+ "," + str);
...
//        String str = System.currentTimeMillis()+new Random().nextInt(9999999)+"username_and_password";
//
//        // 获取token
